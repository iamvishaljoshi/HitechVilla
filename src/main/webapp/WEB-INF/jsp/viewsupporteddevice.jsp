...
<title>View/Delete Device</title>
...
<div style="margin-top: 15px"></div>
        ...
        <div id="addNewAppModal" tabindex="-1">
            ...
            <form:form action="deleteEntityAction.do" method="POST" commandName="device">
            <form:hidden path="id" id="id"/>
              ...
              <div class="modal-footer" id="makeAction">
                <input type="submit" name="action"  type="button" class="btn btn-primary  btn-cons" value="${action}" id="action" onclick="return confirm('Are you sure, you want to delete this device?')">
